...
training_hyperparams = load_config("../../config_files/cross_config_structure_text.txt")
...
# Create the logger
batch_logger = TrainingLogger("cross_training_logs_text.txt", verbose=False)
...
for train_folder, test_folder in zip(train_folders, test_folders):
    try:
        ...
        pooling = "none"  # Defaulting to cls now as it seems to be the best
        ...
        #     val_data.append(pd.read_csv(data_folder + val_data_path, dtype=str))
