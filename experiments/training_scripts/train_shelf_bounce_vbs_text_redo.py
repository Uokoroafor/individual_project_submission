...
training_hyperparams = load_config("../../config_files/sb_config_structure_text.txt")
...
# Create the logger
batch_logger = TrainingLogger("sb_scratch_training_logs_text.txt", verbose=False)
...
folders = ["variable_shelfheight_ballheight"]
