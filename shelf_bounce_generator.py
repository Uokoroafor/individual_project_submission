...
if __name__ == "__main__":
    ...
    variable_ballheight_dict_train = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=shelf_fixed_height,
        fixed_ball_y=True,
        ball_y=lambda: round(random.uniform(*ball_height_limits_train) * HEIGHT, 2),
        fixed_angle=True,
        angle=fixed_angle,
        time_limit=fixed_time,
    )

    variable_ballheight_dict_test = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=shelf_fixed_height,
        fixed_ball_y=True,
        ball_y=lambda: round(
            pick_between_two_ranges(
                ball_height_limits_test[0], ball_height_limits_test[1]
            )
            * HEIGHT,
            2,
        ),
    ...
    variable_ballheight_angle_dict_train = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(random.uniform(*shelf_height_limits_train) * HEIGHT, 2),
        fixed_ball_y=True,
    ...
    variable_ballheight_angle_dict_test = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(
            pick_between_two_ranges(
    ...
    variable_shelfheight_angle_dict_train = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(random.uniform(*shelf_height_limits_train) * HEIGHT, 2),
        fixed_ball_y=True,
    ...
    variable_shelfheight_angle_dict_test = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(
            pick_between_two_ranges(
    ...
    variable_shelfheight_ballheight_dict_train = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(random.uniform(*shelf_height_limits_train) * HEIGHT, 2),
        fixed_ball_y=True,
    ...
    variable_shelfheight_ballheight_dict_test = RandomDict(
        render=False,
        fixed_shelf_y=True,
        shelf_y=lambda: round(
            pick_between_two_ranges(
    ...
    generate_environment_data(
        variable_ballheight_dict_train,
        Env,
        num_iters_train,
        save_path=save_folder + "variable_ballheight/",
        verbose=True,
    )
    generate_environment_data(
        variable_ballheight_dict_test,
        Env,
        num_iters_test,
        save_path=save_folder + "variable_ballheight/oos_",
        verbose=True,
    )
    generate_environment_data(
        variable_ballheight_angle_dict_train,
        Env,
        num_iters_train,
    ...
    generate_environment_data(
        variable_ballheight_angle_dict_test,
        Env,
        num_iters_test,
    ...
    generate_environment_data(
        variable_shelfheight_angle_dict_train,
        Env,
        num_iters_train,
    ...
    generate_environment_data(
        variable_shelfheight_angle_dict_test,
        Env,
        num_iters_test,
    ...
    generate_environment_data(
        variable_shelfheight_ballheight_dict_train,
        Env,
        num_iters_train,
        save_path=save_folder + "variable_shelfheight_ballheight/",
        verbose=True,
    )
    generate_environment_data(
        variable_shelfheight_ballheight_dict_test,
        Env,
        num_iters_test,
        save_path=save_folder + "variable_shelfheight_ballheight/oos_",
        verbose=True,
    )
    generate_environment_data(
        ...
        Env,
        num_iters_train,
        save_path=save_folder + "variable_shelfheight_ballheight_angle/",
        verbose=True,
    )
    generate_environment_data(
        ...
        Env,
        num_iters_test,
        save_path=save_folder + "variable_shelfheight_ballheight_angle/oos_",
        verbose=True,
    )
